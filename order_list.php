            ...
            <div class="index_conten_l">
                <div class="item_01">
                    ...
                    <div class="item_01menu"><a href="favorite_list.php"><h6 class="transition">追蹤清單</h6><span
                                    class="transition">my favourite</span></a></div>
                </div>
            </div>
                                    ...
                                    if ($order['orders_sid'] == $dt['order_sid']):
                                        ...
                                        <div class="order_listbox ">
                                            <figure class="description_10"><a
                                                        href="product_detail.php?id=<?= $dt['product_sid'] ?>">
                                                    <img src="images/<?= $dt['img'] ?>.png"
                                                         alt="<?= $dt['product_name'] ?>"></a></figure>
