...
<div id="product_detail_01"> 
    <div class="index_top">
        ...
        <section>
            <div class="index_main sort_texture01">
    ...
    <section>
        <div class="index_conten_flex sort_texture02">
            <div class="sort_texture02_intro">
                ...
                <div class="sort_texture02_intro_bg">
                    <div class="sort_texture02_intro_box changebox"></div>
                </div>
            </div>
    ...
    <section>
        <div class="index_conten_flex sort_texture03">
            <div class="sort_texture03_intro">
                <div class="sort_texture03_intro_top flex">

                    <div class="sort_texture03_intro_r"></div>
                ...
                <div class="sort_texture03_intro_bg">
                    <div class="sort_texture03_intro_box changebox"></div>
                </div>
            </div>
        ...
        <div class="index_conten_flex sort_texture04">
            <div class="sort_texture04_intro">
                <div class="sort_texture04_intro_top flex">
                    ...
                    <div class="sort_texture04_intro_r"></div>
                </div>
                <div class="sort_texture04_intro_bg">
                    <div class="sort_texture04_intro_box changebox"></div>
                </div>
            </div>
...
<?php include 'sort_texture05.php'; ?>
...
$(window).scroll(function() {
    ...
    if (scrolltop>300 && scrolltop<2000){
        $(".changebg").css('background','url(images/banner/marble_bg.jpg)','no-repeat','center','center');
