                ...
                <div class="item_02_conten">
                    ...
                    ?>
                        ...
                        <div class="order_listbox product-item" data-sid="<?= $k ?>">
                                ...
                                <div class="description_10 product-item-qty"  data-qty="<?= $r['qty'] ?>"><?= $r['qty'] ?></div>
                                <div class="description_10 product-item-price"  data-price="<?= $r['price'] ?>"><?= $r['price'] ?></div>
                        </div>
                    <?php endforeach; ?>

                        <div class="order_listbox order_listbox_tatle">
                                <p>總共 <span class="description_mark" id="total-qty"><?= $total_qty ?></span>
                                    件商品，小計<span class="description_mark"><h3 class="product_price" id="total-price"></h3></span></p>
                        </div>
                        <div class="order_listbox order_listbox_tatle">
                ...
                <!-- 會員名稱 -->
                    <div class="item_02_conten">
                            ...
                            <div class="order_listbox">
                                ...
                                <div class="palette_select description_25">
                                        <select class=" ">
                            ...
                            <div class="order_listbox">
                                ...
                                <div class="description_25"><input type="text" placeholder="統一編號"></div>
                                <div class="description_25"><input type="text" class="description_25" placeholder="公司抬頭"></div>
                            </div>
